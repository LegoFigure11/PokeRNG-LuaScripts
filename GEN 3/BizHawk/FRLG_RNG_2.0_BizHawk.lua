...
local abilityNamesList = {
  ...
  "Shell Armor", "Cacophony", "Air Lock"
}
...
local nationalDexList = {
  ...
  248, 249, 250, 251, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397,
  398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 252,
  253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267,
  268, 269, 270, 271, 272, 273, 274, 275, 290, 291, 292, 276, 277, 285, 286,
  327, 278, 279, 283, 284, 320, 321, 300, 301, 352, 343, 344, 299, 324, 302,
  339, 340, 370, 341, 342, 349, 350, 318, 319, 328, 329, 330, 296, 297, 309,
  310, 322, 323, 363, 364, 365, 331, 332, 361, 362, 337, 338, 298, 325, 326,
  311, 312, 303, 307, 308, 333, 334, 360, 355, 356, 315, 287, 288, 289, 316,
  317, 357, 293, 294, 295, 366, 367, 368, 359, 353, 354, 336, 335, 369, 304,
  305, 306, 351, 313, 314, 345, 346, 347, 348, 280, 281, 282, 371, 372, 373,
  374, 375, 376, 377, 378, 379, 382, 383, 384, 380, 381, 385, 386, 358
}
...
local itemNamesList = {
  ...
  "Burn Heal", "Ice Heal", "Awakening", "Parlyz Heal", "Full Restore",
  ...
  "Yellow Shard", "Green Shard", "unknown", "unknown", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown",
  "HP Up", "Protein", "Iron", "Carbos", "Calcium", "Rare Candy", "PP Up",
  "Zinc", "PP Max", "unknown", "Guard Spec.", "Dire Hit", "X Attack",
  "X Defend", "X Speed", "X Accuracy", "X Special", "Poke Doll",
  "Fluffy Tail", "unknown", "Super Repel", "Max Repel", "Escape Rope",
  "Repel", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown",
  "Sun Stone", "Moon Stone", "Fire Stone", "Thunderstone", "Water Stone",
  "Leaf Stone", "unknown", "unknown", "unknown", "unknown", "TinyMushroom",
  "Big Mushroom", "unknown", "Pearl", "Big Pearl", "Stardust", "Star Piece",
  "Nugget", "Heart Scale", "unknown", "unknown", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "Orange Mail",
  ...
  "Apicot Berry", "Lansat Berry", "Starf Berry", "Enigma Berry", "unknown",
  "unknown", "unknown", "BrightPowder", "White Herb", "Macho Brace",
  ...
  "Lucky Punch", "Metal Powder", "Thick Club", "Stick", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown",
  "unknown", "unknown", "unknown", "unknown", "unknown", "Red Scarf",
  "Blue Scarf", "Pink Scarf", "Green Scarf", "Yellow Scarf", "Mach Bike",
  "Coin Case", "Itemfinder", "Old Rod", "Good Rod", "Super Rod",
  "S.S. Ticket", "Contest Pass", "unknown", "Wailmer Pail", "Devon Goods",
  ...
  "Root Fossil", "Claw Fossil", "Devon Scope", "TM 01", "TM 02", "TM 03",
  "TM 04", "TM 05", "TM 06", "TM 07", "TM 08", "TM 09", "TM 10", "TM 11",
  "TM 12", "TM 13", "TM 14", "TM 15", "TM 16", "TM 17", "TM 18", "TM 19",
  "TM 20", "TM 21", "TM 22", "TM 23", "TM 24", "TM 25", "TM 26", "TM 27",
  "TM 28", "TM 29", "TM 30", "TM 31", "TM 32", "TM 33", "TM 34", "TM 35",
  "TM 36", "TM 37", "TM 38", "TM 39", "TM 40", "TM 41", "TM 42", "TM 43",
  "TM 44", "TM 45", "TM 46", "TM 47", "TM 48", "TM 49", "TM 50", "HM 01",
  "HM 02", "HM 03", "HM 04", "HM 05", "HM 06", "HM 07", "HM 08", "unknown",
  "unknown", "Oak's Parcel", "Poke Flute", "Secret Key", "Bike Voucher",
  "Gold Teeth", "Old Amber", "Card Key", "Lift Key", "Helix Fossil",
  "Dome Fossil", "Silph Scope", "Bicycle", "Town Map", "VS Seeker",
  "Fame Checker", "TM Case", "Berry Pouch", "Teachy TV", "Tri-Pass",
  "Rainbow Pass", "Tea", "MysticTicket", "AuroraTicket", "Powder Jar", "Ruby",
...
local catchRatesList = {
  ...
  45, 150, 25, 190, 75, 170, 50, 255, 90, 255, 120, 45, 190, 75, 190, 75, 255,
  50, 255, 90, 190, 75, 190, 75, 190, 75, 255, 120, 45, 200, 100, 50, 180, 90,
  45, 255, 120, 45, 190, 60, 255, 120, 45, 190, 60, 190, 75, 190, 60, 45, 190,
  45, 190, 75, 190, 75, 190, 60, 190, 90, 45, 45, 190, 75, 225, 60, 190, 60,
  90, 45, 190, 75, 45, 45, 45, 190, 60, 120, 60, 30, 45, 45, 225, 75, 225, 60,
  225, 60, 45, 45, 45, 45, 45, 45, 45, 255, 45, 45, 35, 45, 45, 45, 45, 45,
  45, 45, 45, 45, 45, 25, 3, 3, 3, 45, 45, 45, 3, 45,   -- Gen 2
  45, 45, 45, 45, 45, 45, 45, 45, 45, 255, 90, 255, 90, 255, 90, 255, 90, 90,
  190, 75, 190, 150, 170, 190, 75, 190, 75, 235, 120, 45, 45, 190, 75, 65, 45,
  255, 120, 45, 45, 235, 120, 75, 255, 90, 45, 45, 30, 70, 45, 225, 45, 60,
  190, 75, 190, 60, 25, 190, 75, 45, 25, 190, 45, 60, 120, 60, 190, 75, 225,
  75, 60, 190, 75, 45, 25, 25, 120, 45, 45, 120, 60, 45, 45, 45, 75, 45, 45,
  45, 45, 45, 30, 3, 3, 3, 45, 45, 45, 3, 3, 45,   -- Gen 3
  ...
  200, 225, 45, 190, 90, 200, 45, 30, 125, 190, 75, 255, 120, 45, 255, 60, 60,
  25, 225, 45, 45, 45, 3, 3, 3, 3, 3, 3, 3, 3, 5, 5, 3, 3, 3
}
...
local locationNamesList = {
  ...
  "Cinnabar Island", "Indigo Plateau Exterior", "Saffron City",
  "Saffron City Connection", "One Island", "Two Island", "Three Island",
  "Four Island", "Five Island", "Seven Island", "Six Island", "Route 1",
  "Route 2", "Route 3", "Route 4", "Route 5", "Route 6", "Route 7", "Route 8",
  "Route 9", "Route 10", "Route 11", "Route 12", "Route 13", "Route 14",
  "Route 15", "Route 16", "Route 17", "Route 18", "Route 19", "Route 20",
  "Route 21 North", "Route 21 South", "Route 22", "Route 23", "Route 24",
  "Route 25", "One Island Kindle Road", "One Island Treasure Beach",
  "Two Island Cape Brink", "Three Island Bond Bridge", "Three Island Port",
  "Prototype Sevii Isle 6", "Prototype Sevii Isle 7",
  "Prototype Sevii Isle 8", "Prototype Sevii Isle 9",
  "Five Island Resort Gorgeous", "Five Island Water Labyrinth",
  "Five Island Meadow", "Five Island Memorial Pillar",
  "Six Island Outcast Island", "Six Island Green Path",
  "Six Island Water Path", "Six Island Ruin Valley",
  "Seven Island Trainer Tower", "Seven Island Sevault Canyon Entrance",
  "Seven Island Sevault Canyon", "Seven Island Tanoby Ruins"
}
...
local emuWindow = {}
local mode = {
  "None", "Capture", "100% Catch", "Breeding", "Initial Seed Bot", "Pandora",
  "TID Bot", "Pokemon Info"
}
local index = 1
local prevKey = {}
...
local ballRate = {
  "1", "255", "2", "1.5", "1", "1.5", "1", "1", "1", "1", "1", "1", "1"
}
...
local infoMode = {
  "Gift", "Party", "Party Stats", "Battle Party Stats", "Box",
  "1st Floor Box Stats", "2nd Floor Box Stats", "DayCare Box Stats"
}
local infoIndex = 1
...
function getInput()
  ...
  if (key["Number1"] or key["Keypad1"]) and
      (not prevKey["Number1"] and not prevKey["Keypad1"]) then
    leftArrowColor = "orange"
    index = index - 1

    if index < 1 then index = 8 end
  elseif (key["Number2"] or key["Keypad2"]) and
      (not prevKey["Number2"] and not prevKey["Keypad2"]) then
...
function getInstructionsInput()
  ...
  if mode[index] == "100% Catch" or mode[index] == "Initial Seed Bot" or
      mode[index] == "TID Bot" then
  ...
  if mode[index] == "100% Catch" and showInstructionsText then
    gui.text(emuWindow.rightPadding - 200, emuWindow.topPadding,
      "4 - Hide instructions")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 18,
      "1) During battle, go to BAG > POKE BALLS")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 36,
      "2) Press A on the ball you want to use")
    ...
    gui.text(emuWindow.leftPadding + 30, emuWindow.topPadding + 90,
      "and then unpause the game while holding A.")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 108,
      "5) Wait until delay is calculated")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 126,
      "6) Load the state you made, advance frames until counter")
    gui.text(emuWindow.leftPadding + 30, emuWindow.topPadding + 144,
      "become 0")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 162,
      "7) Unpase the game while holding A")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 180,
      "Note: the delay can be not stable, be sure to check")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 198,
      "counter -1 or +1")
  elseif mode[index] == "Initial Seed Bot" and showInstructionsText then
    ...
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 54,
      "3) Advance a single frame (CTRL+N) while holding SELECT")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 72,
      "4) Unpause the game")
  elseif mode[index] == "TID Bot" and showInstructionsText then
    gui.text(emuWindow.rightPadding - 200, emuWindow.topPadding,
      "4 - Hide instructions")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 18,
      "1) Go to name insertion screen")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 36,
      "2) Insert the name you like")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 54,
      "3) Pause the game")
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 72,
    ...
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 90,
      "5) Unpause the game")
  elseif mode[index] == "100% Catch" or mode[index] == "Initial Seed Bot" or
      mode[index] == "TID Bot" then
    gui.text(emuWindow.rightPadding - 200, emuWindow.topPadding,
      "3 - Show instructions")
  else
...
function getRngInfoInput()
  ...
  if mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] ==
      "Pandora" or mode[index] == "Pokemon Info" then
  ...
  if (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] ==
        "Pandora" or mode[index] == "Pokemon Info") and showRngInfoText then
    gui.text((emuWindow.width / 2) - 63, emuWindow.bottomPadding,
      "6 - Hide RNG info")
  elseif (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] ==
        "Pandora" or mode[index] == "Pokemon Info") and not showRngInfoText then
    gui.text((emuWindow.width / 2) - 63, emuWindow.bottomPadding,
      "5 - Show RNG info")
  else
    showRngInfoText = true
...
function getEncounterAdvancesHit()
  if prevPID ~= read32Bit(wildAddr) then advancesHit = advances + 1 end
end
...
function showRngInfo(initial, current, advances)
  gui.text(emuWindow.leftPadding, emuWindow.bottomPadding - 36,
    string.format("Initial Seed: %04X", initial))
  gui.text(emuWindow.leftPadding + 1, emuWindow.bottomPadding - 18,
    string.format("Current Seed: %08X", current))
  gui.text(emuWindow.leftPadding + 1, emuWindow.bottomPadding,
    "Advances: " .. advances)
end
...
function showTrainerIDs(addr)
  ...
  gui.text(emuWindow.rightPadding - 85, emuWindow.bottomPadding - 18,
    string.format("TID: %d", trainerIDs[1]))
  gui.text(emuWindow.rightPadding - 85, emuWindow.bottomPadding,
    string.format("SID: %d", trainerIDs[2]))
end
...
function showIVsAndHP(IVsValue, isRoamer)
  ...
  local hpType = floor(((hpIV % 2 + 2 * (atkIV % 2) + 4 * (defIV % 2) + 8 *
    ...
    (spDefIV % 2)) * 15) / 63)
  local hpPower = floor(((band(hpIV, 2) / 2 + band(atkIV, 2) + 2 *
      band(defIV, 2) + 4 * band(spdIV, 2) + 8 *
      band(spAtkIV, 2) + 16 * band(spDefIV, 2)) * 40) /
    63 + 30)

  if isRoamer then textXOffset = 419 end

  gui.text(emuWindow.leftPadding + 1 + textXOffset, emuWindow.topPadding + 90,
    "IVs:")
  gui.text(emuWindow.leftPadding + 51 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", hpIV),
    getIVColor(hpIV))
  gui.text(emuWindow.leftPadding + 71 + textXOffset,
    emuWindow.topPadding + 90, "/")
  gui.text(emuWindow.leftPadding + 81 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", atkIV),
    getIVColor(atkIV))
  gui.text(emuWindow.leftPadding + 101 + textXOffset,
    emuWindow.topPadding + 90, "/")
  gui.text(emuWindow.leftPadding + 111 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", defIV),
    getIVColor(defIV))
  gui.text(emuWindow.leftPadding + 131 + textXOffset,
    emuWindow.topPadding + 90, "/")
  gui.text(emuWindow.leftPadding + 141 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", spAtkIV),
    getIVColor(spAtkIV))
  gui.text(emuWindow.leftPadding + 161 + textXOffset,
    emuWindow.topPadding + 90, "/")
  gui.text(emuWindow.leftPadding + 171 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", spDefIV),
    getIVColor(spDefIV))
  gui.text(emuWindow.leftPadding + 191 + textXOffset,
    emuWindow.topPadding + 90, "/")
  gui.text(emuWindow.leftPadding + 201 + textXOffset,
    emuWindow.topPadding + 90, string.format("%02d", spdIV),
    getIVColor(spdIV))

  gui.text(emuWindow.leftPadding + 1 + textXOffset,
    emuWindow.topPadding + 108,
    "HPower: " .. HPTypeNamesList[hpType + 1] .. " " .. hpPower)
end

function isEgg(addr) return read16Bit(addr + 0x12) == 0x601 end
...
function getEncounterMethod(PID, IVsValue)
  ...
  gui.text(emuWindow.rightPadding - 350, emuWindow.topPadding + 252,
    string.format("Method %d", encounterMethod))
  gui.text(emuWindow.rightPadding - 350, emuWindow.topPadding + 270,
    string.format("Hit Seed: %08X", hitEncounterSeed))
  gui.text(emuWindow.rightPadding - 350, emuWindow.topPadding + 288,
    string.format("Hit Advances: %d", advancesHit))
end
...
function shinyCheck(PID, addr)
  ...
  local shinyTypeValue = bxor(bxor(trainerIDs[2], trainerIDs[1]),
    bxor(lowPID, highPID))
...
function showMoves(value1, value2)
  ...
  if move1Number <= 354 then
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 162,
      "Move: " .. moveNamesList[move1Number + 1])
  end

  if move2Number <= 354 then
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 180,
      "Move: " .. moveNamesList[move2Number + 1])
  end

  if move3Number <= 354 then
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 198,
      "Move: " .. moveNamesList[move3Number + 1])
  end

  if move4Number <= 354 then
    gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 216,
      "Move: " .. moveNamesList[move4Number + 1])
  end
end
...
function showPP(value)
  ...
  gui.text(emuWindow.leftPadding + 250, emuWindow.topPadding + 162, PPmove1,
    getPPColor(PPmove1))
  gui.text(emuWindow.leftPadding + 210, emuWindow.topPadding + 180, "PP:")
  gui.text(emuWindow.leftPadding + 250, emuWindow.topPadding + 180, PPmove2,
    getPPColor(PPmove2))
  gui.text(emuWindow.leftPadding + 210, emuWindow.topPadding + 198, "PP:")
  gui.text(emuWindow.leftPadding + 250, emuWindow.topPadding + 198, PPmove3,
    getPPColor(PPmove3))
  gui.text(emuWindow.leftPadding + 210, emuWindow.topPadding + 216, "PP:")
  gui.text(emuWindow.leftPadding + 250, emuWindow.topPadding + 216, PPmove4,
    getPPColor(PPmove4))
end
...
function showInfo(addr)
  ...
  local IVsAndAbilityValue = bxor(read32Bit(addr + 0x20 + miscOffset + 0x4),
    decryptionKey)
  local speciesAndItemValue = bxor(read32Bit(addr + 0x20 + growthOffset),
    decryptionKey)
  local moves1Value = bxor(read32Bit(addr + 0x20 + attacksOffset),
    decryptionKey)
  local moves2Value = bxor(read32Bit(addr + 0x20 + attacksOffset + 0x4),
    decryptionKey)
  local PPValue = bxor(read32Bit(addr + 0x20 + attacksOffset + 0x8),
    decryptionKey)
  ...
  if speciesDexNumber ~= nil and speciesDexNumber < 387 and abilityNumber ~=
      nil then
    abilityName =
        abilityNamesList[pokemonAbilities[speciesDexNumber][abilityNumber]]
  end
  ...
  gui.text(emuWindow.leftPadding + 51, emuWindow.topPadding + 36,
    string.format("%08X%s", PID, shinyType[2]), shinyType[1])
  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 54,
    "Nature: " .. natureNamesList[natureNumber + 1])
...
function showOpponentPokemonInfo() showInfo(wildAddr) end
...
function showRoamerInfo()
  ...
  if isRoamerActive then
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 18,
      "Active Roamer? Yes")

    if roamerSpeciesName ~= nil then
      gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 36,
        "Species: " .. roamerSpeciesName)
    end

    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 54, "PID:")
    gui.text(emuWindow.leftPadding + 470, emuWindow.topPadding + 54,
      string.format("%08X%s", roamerPID, roamerShinyType[2]),
      roamerShinyType[1])
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 72,
      "Nature: " .. natureNamesList[roamerNatureNumber + 1])
    showIVsAndHP(band(roamerIVsValue, 0xFF), isRoamerActive)
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 126,
      "HP: " .. roamerHP)
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 144,
      "Level: " .. roamerLevel)
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 162,
      "Status condition: " .. roamerStatus)
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 180,
      "Current position:")
    gui.text(emuWindow.leftPadding + 420, emuWindow.topPadding + 198,
      locationNamesList[roamerMapNum + 1],
...
function getBikeMod(rate)
  ...
  if isPlayerOnBike then rate = floor((rate * 80) / 100) end
...
function getEncounterCheckValue(seed) return rshift(seed, 16) % 0x640 end
...
function getEncounterMissingSteps(rate, rateBuff, rateBase)
  ...
  while rateBuff ~= 0 and isEncounterStep == false do
    ...
    if finalRate > 1600 then finalRate = 1600 end
...
function showMissingStepsForEncounter()
  ...
  encounterMissingSteps = getEncounterMissingSteps(encounterRate,
    encounterRateBuff,
    encounterRateBase)

  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding + 252,
    "Steps for wild encounter: " .. encounterMissingSteps)
end
...
function getCatchDelay(isSafariZone)
  ...
  if isSafariZone then safariOffset = 80 end
...
function findCatchSeed(seed, delay)
  ...
  for i = 1, delay do tempSeed = LCRNG(tempSeed, 0x41C6, 0x4E6D, 0x6073) end
...
function getBonusBall(speciesDexNumber, isSafariZone)
  ...
  local dexCaughtMask = rshift(lshift(0x1000000,
    band((speciesDexNumber - 1), 7)), 24)
  local dexCaughtFlag = band(read8Bit(saveBlock2 + 0x28 +
      band(
        rshift(
          lshift(speciesDexNumber - 1,
            16), 19), 0xFF)),
    dexCaughtMask)
  ...
  if isSafariZone then return ballRate[6] end
...
function calcCatchProb(isSafariZone)
  ...
  local a = floor(((((3 * HPmax) - (2 * HPcurrent)) * catchRate * bonusBall) /
    (3 * HPmax)) * bonusStatus)
...
function findSureCatch(seed, catchProbability, isSafariZone)
  ...
  while ballShakes ~= 4 do
    ...
    if isSafariZone and delay % 2 ~= 0 then ballShakes = 0 end

    tempSeed1 = LCRNG(tempSeed1, 0x41C6, 0x4E6D, 0x6073)
    tempSeed = tempSeed1

    if ballShakes ~= 4 then delay = delay + 1 end
  end

  if isSafariZone then delay = delay / 2 end
...
function catchRng()
  ...
  if wildCatchDelay <= 0 then
    gui.text(emuWindow.leftPadding + 1, emuWindow.height / 2,
      "Delay not calculated yet")
  else
    gui.text(emuWindow.leftPadding + 1, emuWindow.height / 2,
      "Delay calculated")
  end
  ...
  if wildCatchDelay > 0 then
    sureCatchDelay = findSureCatch(catchSeed, calcCatchProb(isSafariZone),
      isSafariZone)

    gui.text(emuWindow.leftPadding, (emuWindow.height / 2) + 18,
      "100% catch missing advances: " .. sureCatchDelay)
  end
end
...
function showDayCareInfo()
  ...
  if not isEggReady then
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 108,
      "Steps Counter: " .. eggStepsCounter)
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 126,
      "Egg is not ready")
  end
  ...
  if isEggReady then
    ...
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 126,
      "Egg generated, go get it!")
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 144,
      string.format("Egg lower PID: %04X", eggLowPid))
  elseif eggStepsCounter == 1 then
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 144,
      "Next step might generate")
    gui.text(emuWindow.leftPadding + 388, emuWindow.topPadding + 162,
      "an egg!")
...
function showPartyEggInfo()
  ...
  if isEgg(lastPartySlotAddr) then showInfo(lastPartySlotAddr) end
end

function advanceToDelay(delay, state)
  state = state or nil

  while emu.framecount() ~= delay do emu.frameadvance() end
  ...
  if state ~= nil then joypad.set({ A = true }) end
end

function writeCheck() initSeedWritten = true end
...
function isInitSeedFound()
  ...
  for i = 1, table.getn(botTargetInitSeeds) do
    if init == botTargetInitSeeds[i] then return true end
  end
  return false
end
...
function showFoundInitSeed()
  ...
  if initSeedFound then
    ...
    gui.text(emuWindow.leftPadding, (emuWindow.height / 2) + 18,
      string.format("Initial Seed: %04X", init))
...
function isTIDFound()
  ...
  for i = 1, table.getn(botTargetTIDs) do
    if TID == botTargetTIDs[i] then return true end
  end
  return false
end
...
function showFoundTID()
  ...
  if TIDFound then
    gui.text(emuWindow.leftPadding + 1, emuWindow.height / 2, "Found!")
    gui.text(emuWindow.leftPadding + 1, (emuWindow.height / 2) + 18,
      "TID: " .. TID)
...
function TIDBot()
  ...
  if key.Start then TIDBotLoop() end
...
function getInfoInput()
  ...
  if (key["Number3"] or key["Keypad3"]) and
      (not prevKeyInfo["Number3"] and not prevKeyInfo["Keypad3"]) then
    leftInfoArrowColor = "orange"
    infoIndex = infoIndex - 1

    if infoIndex < 1 then infoIndex = 8 end
  elseif (key["Number4"] or key["Keypad4"]) and
      (not prevKeyInfo["Number4"] and not prevKeyInfo["Keypad4"]) then
    rightInfoArrowColor = "orange"
    infoIndex = infoIndex + 1

    if infoIndex > 8 then infoIndex = 1 end
  end
...
function showPokemonInfo()
  ...
  elseif infoMode[infoIndex] == "Box" then
    ...
    boxSelectedPokemonAddr = boxAddr + (0x1E * currBoxNumber * 0x50) +
        (boxSelectedSlotNumber * 0x50)
  ...
  elseif infoMode[infoIndex] == "Party Stats" or infoMode[infoIndex] ==
      "2nd Floor Box Stats" or infoMode[infoIndex] == "DayCare Box Stats" then
...
while warning == "" do
  getScreenDimensions()
  getInput()
  gui.text(emuWindow.leftPadding + 1, emuWindow.topPadding,
    "Mode: " .. mode[index])
  ...
  if mode[index] == "Capture" then
    ...
    if showRoamerInfoText then showRoamerInfo() end
  ...
  elseif mode[index] == "Pandora" then
    gui.text(emuWindow.leftPadding + 1, emuWindow.bottomPadding - 54,
      "Temp TID: " .. initSeed)
  elseif mode[index] == "TID Bot" then
    TIDBot()
  elseif mode[index] == "Pokemon Info" then
    getInfoInput()
    gui.text((emuWindow.width / 2) - 63, emuWindow.bottomPadding - 54,
      "Mode: " .. infoMode[infoIndex])
    drawArrowLeft(187, 135, leftInfoArrowColor)
    gui.text((emuWindow.width / 2) + 230, emuWindow.bottomPadding - 54,
      "3 - 4")
