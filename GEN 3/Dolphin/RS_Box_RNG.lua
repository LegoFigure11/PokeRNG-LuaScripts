...
local moveNamesList = {
    ...
    "Psybeam",
    "Bubble Beam", "Aurora Beam", "Hyper Beam", "Peck", "Drill Peck", "Submission", "Low Kick", "Counter",
    "Seismic Toss",
    "Strength", "Absorb", "Mega Drain", "Leech Seed", "Growth", "Razor Leaf", "Solar Beam", "Poison Powder",
    "Stun Spore",
    ...
    "Focus Energy", "Bide", "Metronome", "Mirror Move", "Self-Destruct", "Egg Bomb", "Lick", "Smog", "Sludge",
    "Bone Club",
    ...
    "Transform",
    "Bubble", "Dizzy Punch", "Spore", "Flash", "Psywave", "Splash", "Acid Armor", "Crabhammer", "Explosion",
    "Fury Swipes",
    ...
    "Snore", "Curse", "Flail", "Conversion 2", "Aeroblast", "Cotton Spore", "Reversal", "Spite", "Powder Snow",
    "Protect",
    ...
    "Howl",
    "Dragon Claw", "Frenzy Plant", "Bulk Up", "Bounce", "Mud Shot", "Poison Tail", "Covet", "Volt Tackle",
    "Magical Leaf",
...
local itemNamesList = {
    ...
    "Repeat Ball",
    "Timer Ball", "Luxury Ball", "Premier Ball", "Potion", "Antidote", "Burn Heal", "Ice Heal", "Awakening",
    "Parlyz Heal", "Full Restore",
    ...
    "Chesto Berry",
    "Pecha Berry", "Rawst Berry", "Aspear Berry", "Leppa Berry", "Oran Berry", "Persim Berry", "Lum Berry",
    ...
    "Claw Fossil", "Devon Scope", "TM 01", "TM 02", "TM 03", "TM 04", "TM 05", "TM 06", "TM 07", "TM 08", "TM 09",
    "TM 10", "TM 11", "TM 12",
...
function reverse32Bit(addr)
    ...
    local reversed32BitValue = ((value & 0xFF) * 0x1000000) + ((value & 0xFF00) * 0x100) + ((value >> 8) & 0xFF00) +
    (value >> 24)
...
function getIVsAndHP(IVsValue)
    ...
    local hpType = ((hpIV % 2 + 2 * (atkIV % 2) + 4 * (defIV % 2) + 8 * (spdIV % 2) + 16 * (spAtkIV % 2) + 32 * (spDefIV % 2)) * 15) //
    63
    local hpPower = ((((hpIV & 2) / 2 + (atkIV & 2) + 2 * (defIV & 2) + 4 * (spdIV & 2) + 8 * (spAtkIV & 2) + 16 * (spDefIV & 2)) * 40) // 63) +
    30
