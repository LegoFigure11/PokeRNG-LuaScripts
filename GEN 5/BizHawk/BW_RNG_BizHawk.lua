...
function showInfo(pidAddr)
      ...
      if mode[index] ~= "Breeding" or isEgg then
            ...
            gui.pixelText(1, 22,
                  "Nature: " .. natureNamesList[(natureIndex > 25 or natureIndex == nil) and 1 or natureIndex])
            gui.pixelText(1, 29,
...
function showRoamerInfo(roamerAddr)
      ...
      if isRoamerActive then
            ...
            gui.pixelText(1, 79,
                  (roamerMapIndex > 427 or roamerMapIndex < 1) and "" or locationNamesList[roamerMapIndex + 1],
