...
local abilityNamesList = {
      ...
      "Slow Start", "Scrappy", "Storm Drain", "Ice Body", "Solid Rock", "Snow Warning", "Honey Gather", "Frisk",
      "Reckless",
      "Multitype", "Flower Gift", "Bad Dreams",
      -- Gen 5
      "Pickpocket", "Sheer Force", "Contrary", "Unnerve", "Defiant", "Defeatist", "Cursed Body", "Healer",
      "Friend Guard",
...
local moveNamesList = {
      ...
      "Explosion", "Fury Swipes", "Bonemerang", "Rest", "Rock Slide", "Hyper Fang", "Sharpen", "Conversion",
      "Tri Attack",
      ...
      "Memento", "Facade", "Focus Punch", "Smelling Salts", "Follow Me", "Nature Power", "Charge", "Taunt",
      "Helping Hand",
      "Trick", "Role Play", "Wish", "Assist", "Ingrain", "Superpower", "Magic Coat", "Recycle", "Revenge", "Brick Break",
      "Yawn", "Knock Off", "Endeavor", "Eruption", "Skill Swap", "Imprison", "Refresh", "Grudge", "Snatch",
      "Secret Power",
      ...
      "Blast Burn", "Hydro Cannon", "Meteor Mash", "Astonish", "Weather Ball", "Aromatherapy", "Fake Tears",
      "Air Cutter",
      ...
      "Muddy Water",
      "Bullet Seed", "Aerial Ace", "Icicle Spear", "Iron Defense", "Block", "Howl", "Dragon Claw", "Frenzy Plant",
      "Bulk Up",
      "Bounce", "Mud Shot", "Poison Tail", "Covet", "Volt Tackle", "Magical Leaf", "Water Sport", "Calm Mind",
      "Leaf Blade",
      ...
      "Natural Gift",
      "Feint", "Pluck", "Tailwind", "Acupressure", "Metal Burst", "U-turn", "Close Combat", "Payback", "Assurance",
      "Embargo",
      "Fling", "Psycho Shift", "Trump Card", "Heal Block", "Wring Out", "Power Trick", "Gastro Acid", "Lucky Chant",
      "Me First",
      ...
      "Dark Pulse", "Night Slash", "Aqua Tail", "Seed Bomb", "Air Slash", "X-Scissor", "Bug Buzz", "Dragon Pulse",
      "Dragon Rush",
      ...
      "Cross Poison", "Gunk Shot", "Iron Head", "Magnet Bomb", "Stone Edge", "Captivate", "Stealth Rock", "Grass Knot",
      "Chatter",
      "Judgment", "Bug Bite", "Charge Beam", "Wood Hammer", "Aqua Jet", "Attack Order", "Defend Order", "Heal Order",
      "Head Smash",
      "Double Hit", "Roar of Time", "Spacial Rend", "Lunar Dance", "Crush Grip", "Magma Storm", "Dark Void",
      "Seed Flare",
      "Ominous Wind", "Shadow Force",
      -- Gen 5
      "Hone Claws", "Wide Guard", "Guard Split", "Power Split", "Wonder Room", "Psyshock", "Venoshock", "Autotomize",
      "Rage Powder",
      "Telekinesis", "Magic Room", "Smack Down", "Storm Throw", "Flame Burst", "Sludge Wave", "Quiver Dance",
      "Heavy Slam",
      "Synchronoise", "Electro Ball", "Soak", "Flame Charge", "Coil", "Low Sweep", "Acid Spray", "Foul Play",
      "Simple Beam",
      "Entrainment", "After You", "Round", "Echoed Voice", "Chip Away", "Clear Smog", "Stored Power", "Quick Guard",
      "Ally Switch",
      "Scald", "Shell Smash", "Heal Pulse", "Hex", "Sky Drop", "Shift Gear", "Circle Throw", "Incinerate", "Quash",
      "Acrobatics",
      ...
      "Searing Shot", "Techno Blast", "Relic Song", "Secret Sword", "Glaciate", "Bolt Strike", "Blue Flare",
      "Fiery Dance",
...
local itemNamesList = {
      ...
      "Lemonade", "Moomoo Milk", "EnergyPowder", "Energy Root", "Heal Powder", "Revival Herb", "Ether", "Max Ether",
      "Elixir",
      "Max Elixir", "Lava Cookie", "Berry Juice", "Sacred Ash", "HP Up", "Protein", "Iron", "Carbos", "Calcium",
      "Rare Candy",
      "PP Up", "Zinc", "PP Max", "Old Gateau", "Guard Spec.", "Dire Hit", "X Attack", "X Defend", "X Speed",
      "X Accuracy", "X Special",
      "X Sp. Def", "Poké Doll", "Fluffy Tail", "Blue Flute", "Yellow Flute", "Red Flute", "Black Flute", "White Flute",
      "Shoal Salt",
      "Shoal Shell", "Red Shard", "Blue Shard", "Yellow Shard", "Green Shard", "Super Repel", "Max Repel", "Escape Rope",
      "Repel",
      "Sun Stone", "Moon Stone", "Fire Stone", "Thunder Stone", "Water Stone", "Leaf Stone", "TinyMushroom",
      "Big Mushroom", "Pearl",
      "Big Pearl", "Stardust", "Star Piece", "Nugget", "Heart Scale", "Honey", "Growth Mulch", "Damp Mulch",
      "Stable Mulch",
      "Gooey Mulch", "Root Fossil", "Claw Fossil", "Helix Fossil", "Dome Fossil", "Old Amber", "Armor Fossil",
      "Skull Fossil",
      "Rare Bone", "Shiny Stone", "Dusk Stone", "Dawn Stone", "Oval Stone", "Odd Keystone", "Griseous Orb", "unknown",
      "unknown",
      "unknown", "Douse Drive", "Shock Drive", "Burn Drive", "Chill Drive", "unknown", "unknown", "unknown", "unknown",
      "unknown",
      "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "unknown", "Sweet Heart",
      "Adamant Orb",
      "Lustrous Orb", "Greet Mail", "Favored Mail", "RSVP Mail", "Thanks Mail", "Inquiry Mail", "Like Mail",
      "Reply Mail",
      "BridgeMail S", "BridgeMail D", "BridgeMail T", "BridgeMail V", "BridgeMail M", "Cheri Berry", "Chesto Berry",
      "Pecha Berry",
      "Rawst Berry", "Aspear Berry", "Leppa Berry", "Oran Berry", "Persim Berry", "Lum Berry", "Sitrus Berry",
      "Figy Berry", "Wiki Berry",
      "Mago Berry", "Aguav Berry", "Iapapa Berry", "Razz Berry", "Bluk Berry", "Nanab Berry", "Wepear Berry",
      "Pinap Berry", "Pomeg Berry",
      "Kelpsy Berry", "Qualot Berry", "Hondew Berry", "Grepa Berry", "Tamato Berry", "Cornn Berry", "Magost Berry",
      "Rabuta Berry",
      "Nomel Berry", "Spelon Berry", "Pamtre Berry", "Watmel Berry", "Durin Berry", "Belue Berry", "Occa Berry",
      "Passho Berry",
      "Wacan Berry", "Rindo Berry", "Yache Berry", "Chople Berry", "Kebia Berry", "Shuca Berry", "Coba Berry",
      "Payapa Berry", "Tanga Berry",
      ...
      "Custap Berry",
      "Jaboca Berry", "Rowap Berry", "BrightPowder", "White Herb", "Macho Brace", "Exp. Share", "Quick Claw",
      "Soothe Bell", "Mental Herb",
      "Choice Band", "King's Rock", "SilverPowder", "Amulet Coin", "Cleanse Tag", "Soul Dew", "DeepSeaTooth",
      "DeepSeaScale", "Smoke Ball",
      "Everstone", "Focus Band", "Lucky Egg", "Scope Lens", "Metal Coat", "Leftovers", "Dragon Scale", "Light Ball",
      "Soft Sand", "Hard Stone",
      ...
      "Lucky Punch",
      "Metal Powder", "Thick Club", "Stick", "Red Scarf", "Blue Scarf", "Pink Scarf", "Green Scarf", "Yellow Scarf",
      "Wide Lens",
      "Muscle Band", "Wise Glasses", "Expert Belt", "Light Clay", "Life Orb", "Power Herb", "Toxic Orb", "Flame Orb",
      "Quick Powder",
      "Focus Sash", "Zoom Lens", "Metronome", "Iron Ball", "Lagging Tail", "Destiny Knot", "Black Sludge", "Icy Rock",
      "Smooth Rock",
      "Heat Rock", "Damp Rock", "Grip Claw", "Choice Scarf", "Sticky Barb", "Power Bracer", "Power Belt", "Power Lens",
      "Power Band",
      "Power Anklet", "Power Weight", "Shed Shell", "Big Root", "Choice Specs", "Flame Plate", "Splash Plate",
      "Zap Plate", "Meadow Plate",
      "Icicle Plate", "Fist Plate", "Toxic Plate", "Earth Plate", "Sky Plate", "Mind Plate", "Insect Plate",
      "Stone Plate", "Spooky Plate",
      "Draco Plate", "Dread Plate", "Iron Plate", "Odd Incense", "Rock Incense", "Full Incense", "Wave Incense",
      "Rose Incense",
      "Luck Incense", "Pure Incense", "Protector", "Electirizer", "Magmarizer", "Dubious Disc", "Reaper Cloth",
      "Razor Claw", "Razor Fang",
      "TM01", "TM02", "TM03", "TM04", "TM05", "TM06", "TM07", "TM08", "TM09", "TM10", "TM11", "TM12", "TM13", "TM14",
      "TM15", "TM16", "TM17",
      "TM18", "TM19", "TM20", "TM21", "TM22", "TM23", "TM24", "TM25", "TM26", "TM27", "TM28", "TM29", "TM30", "TM31",
      "TM32", "TM33", "TM34",
      "TM35", "TM36", "TM37", "TM38", "TM39", "TM40", "TM41", "TM42", "TM43", "TM44", "TM45", "TM46", "TM47", "TM48",
      "TM49", "TM50", "TM51",
      "TM52", "TM53", "TM54", "TM55", "TM56", "TM57", "TM58", "TM59", "TM60", "TM61", "TM62", "TM63", "TM64", "TM65",
      "TM66", "TM67", "TM68",
      "TM69", "TM70", "TM71", "TM72", "TM73", "TM74", "TM75", "TM76", "TM77", "TM78", "TM79", "TM80", "TM81", "TM82",
      "TM83", "TM84", "TM85",
      "TM86", "TM87", "TM88", "TM89", "TM90", "TM91", "TM92", "HM01", "HM02", "HM03", "HM04", "HM05", "HM06", "unknown",
      "unknown",
      "Explorer Kit", "Loot Sack", "Rule Book", "Poké Radar", "Point Card", "Journal", "Seal Case", "Fashion Case",
      "Seal Bag", "Pal Pad",
      "Works Key", "Old Charm", "Galactic Key", "Red Chain", "Town Map", "Vs. Seeker", "Coin Case", "Old Rod",
      "Good Rod", "Super Rod",
      "Sprayduck", "Poffin Case", "Bicycle", "Suite Key", "Oak's Letter", "Lunar Wing", "Member Card", "Azure Flute",
      "S.S. Ticket",
      "Contest Pass", "Magma Stone", "Parcel", "Coupon 1", "Coupon 2", "Coupon 3", "Storage Key", "SecretPotion",
      "Vs. Recorder", "Gracidea",
      "Secret Key", "Apricorn Box", "Unown Report", "Berry Pots", "Dowsing MCHN", "Blue Card", "SlowpokeTail",
      "Clear Bell", "Card Key",
      "Basement Key", "SquirtBottle", "Red Scale", "Lost Item", "Pass", "Machine Part", "Silver Wing", "Rainbow Wing",
      "Mystery Egg",
      "Red Apricorn", "Ylw Apricorn", "Blu Apricorn", "Grn Apricorn", "Pnk Apricorn", "Wht Apricorn", "Blk Apricorn",
      "Fast Ball", "Level Ball",
      "Lure Ball", "Heavy Ball", "Love Ball", "Friend Ball", "Moon Ball", "Sport Ball", "Park Ball", "Photo Album",
      "GB Sounds", "Tidal Bell",
      "RageCandyBar", "Data Card 01", "Data Card 02", "Data Card 03", "Data Card 04", "Data Card 05", "Data Card 06",
      "Data Card 07",
      "Data Card 08", "Data Card 09", "Data Card 10", "Data Card 11", "Data Card 12", "Data Card 13", "Data Card 14",
      "Data Card 15",
      "Data Card 16", "Data Card 17", "Data Card 18", "Data Card 19", "Data Card 20", "Data Card 21", "Data Card 22",
      "Data Card 23",
      "Data Card 24", "Data Card 25", "Data Card 26", "Data Card 27", "Jade Orb", "Lock Capsule", "Red Orb", "Blue Orb",
      "Enigma Stone",
      "Prism Scale", "Eviolite", "Float Stone", "Rocky Helmet", "Air Balloon", "Red Card", "Ring Target", "Binding Band",
      "Absorb Bulb",
      "Cell Battery", "Eject Button", "Fire Gem", "Water Gem", "Electric Gem", "Grass Gem", "Ice Gem", "Fighting Gem",
      "Poison Gem",
      ...
      "Liberty Pass", "Pass Orb", "Dream Ball", "Poké Toy", "Prop Case", "Dragon Skull", "BalmMushroom", "Big Nugget",
      "Pearl String",
      "Comet Shard", "Relic Copper", "Relic Silver", "Relic Gold", "Relic Vase", "Relic Band", "Relic Statue",
      "Relic Crown", "Casteliacone",
      "Dire Hit 2", "X Speed 2", "X Special 2", "X Sp. Def 2", "X Defend 2", "X Attack 2", "X Accuracy 2", "X Speed 3",
      "X Special 3",
      "X Sp. Def 3", "X Defend 3", "X Attack 3", "X Accuracy 3", "X Speed 6", "X Special 6", "X Sp. Def 6", "X Defend 6",
      "X Attack 6",
      "X Accuracy 6", "Ability Urge", "Item Drop", "Item Urge", "Reset Urge", "Dire Hit 3", "Light Stone", "Dark Stone",
      "TM93", "TM94",
      "TM95", "Xtransceiver", "God Stone", "Gram 1", "Gram 2", "Gram 3", "Xtransceiver", "Medal Box", "DNA Splicers",
      "DNA Splicers", "Permit",
      "Oval Charm", "Shiny Charm", "Plasma Card", "Grubby Hanky", "Colress MCHN", "Dropped Item", "Dropped Item",
      "Reveal Glass" }

local locationNamesList = { "Black City", "Black City", "Black City", "Black City", "Black City", "Black City",
      "Striaton City", "Striaton City", "Striaton City",
      "Striaton City", "Striaton City", "Striaton City", "Striaton City", "Striaton City", "Striaton City",
      "Striaton City", "Nacrene City", "Nacrene City", "Nacrene City",
      "Nacrene City", "Nacrene City", "Nacrene City", "Nacrene City", "Nacrene City", "Nacrene City", "Nacrene City",
      "Nacrene City", "Nacrene Gate", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia Gate", "Royal Unova", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Castelia City",
      "Castelia City", "Castelia City", "Castelia City", "Nimbasa City", "Nimbasa City", "Nimbasa City", "Nimbasa City",
      "Gear Station", "Gear Station", "Gear Station",
      "Gear Station", "Gear Station", "Gear Station", "Gear Station", "Gear Station", "Gear Station", "Battle Subway",
      "Battle Subway", "Musical Theater", "Musical Theater",
      "Nimbasa City", "Nimbasa City", "Nimbasa City", "Nimbasa City", "Nimbasa City", "Nimbasa City", "Nimbasa City",
      "Nimbasa City", "Nimbasa City", "Nimbasa City",
      "Nimbasa City", "Nimbasa Gate", "Nimbasa Gate", "Nimbasa Gate", "Nimbasa City", "Nimbasa City", "Nimbasa City",
      "Driftveil City", "Driftveil City", "Driftveil City",
      "Driftveil City", "Driftveil City", "Driftveil City", "Driftveil City", "Driftveil City", "Driftveil City",
      "Driftveil City", "Driftveil City", "Mistralton City",
      "Mistralton City", "Mistralton City", "Mistralton City", "Mistralton City", "Mistralton City", "Icirrus City",
      "Icirrus City", "Icirrus City", "Icirrus City",
      "Icirrus City", "Icirrus City", "Icirrus City", "Opelucid City", "Opelucid City", "Opelucid City", "Opelucid City",
      "Opelucid City", "Opelucid City", "Opelucid City",
      "Opelucid City", "Opelucid City", "Opelucid City", "Opelucid City", "Opelucid Gate", "Opelucid Gate",
      "Opelucid Gate", "Opelucid City", "Opelucid City", "Pokémon League",
      "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League",
      "Pokémon League", "Pokémon League", "Pokémon League",
      "Pokémon League", "Unity Tower", "Unity Tower", "Unity Tower", "－－－－－－－－－－", "－－－－－－－－－－",
      "Dreamyard", "Dreamyard", "Pinwheel Forest", "Pinwheel Forest",
      "Rumination Field", "Desert Resort", "Desert Resort", "Route Gate", "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle", "Relic Castle",
      "Relic Castle", "Relic Castle", "Relic Castle", "Cold Storage", "Cold Storage", "Cold Storage", "Chargestone Cave",
      "Chargestone Cave", "Chargestone Cave", "Chargestone Cave",
      "Twist Mountain", "Twist Mountain", "Twist Mountain", "Twist Mountain", "Twist Mountain", "Twist Mountain",
      "Twist Mountain", "Dragonspiral Tower", "Dragonspiral Tower",
      "Dragonspiral Tower", "Dragonspiral Tower", "Dragonspiral Tower", "Dragonspiral Tower", "Dragonspiral Tower",
      "Dragonspiral Tower", "Dragonspiral Tower", "Victory Road", "Victory Road",
      "Victory Road", "Victory Road", "Victory Road", "Victory Road", "Victory Road", "Victory Road", "Victory Road",
      "Victory Road", "Victory Road", "Victory Road", "Victory Road",
      "Victory Road", "Victory Road", "Trial Chamber", "Giant Chasm", "Giant Chasm", "Giant Chasm", "Giant Chasm",
      "Giant Chasm", "Liberty Garden", "Liberty Garden", "Liberty Garden",
      "P2 Laboratory", "P2 Laboratory", "Undella Bay", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins",
      "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins",
      "Skyarrow Bridge", "Bridge Gate", "Bridge Gate", "Bridge Gate", "Driftveil Drawbridge", "Tubeline Bridge",
      "Village Bridge", "Village Bridge", "Village Bridge", "Village Bridge",
      "Village Bridge", "Village Bridge", "Village Bridge", "Village Bridge", "Marvelous Bridge", "N's Castle",
      "N's Castle", "N's Castle", "N's Castle", "N's Castle", "N's Castle",
      "N's Castle", "N's Castle", "N's Castle", "N's Castle", "N's Castle", "N's Castle", "N's Castle", "N's Castle",
      "N's Castle", "Entralink", "Entree Forest", "Entree Forest",
      "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest",
      "Entree Forest", "Nimbasa City", "Driftveil City", "Mistralton City",
      "Icirrus City", "Opelucid City", "Black City", "White Forest", "Cold Storage", "Chargestone Cave",
      "Twist Mountain", "Dragonspiral Tower", "Giant Chasm", "Driftveil Drawbridge",
      "Tubeline Bridge", "Marvelous Bridge", "Route 5", "Route 6", "Route 7", "Route 8", "Route 9", "Route 11",
      "Route 12", "Route 13", "Route 14", "Route 15", "Route 16", "Lacunosa Town",
      "Undella Town", "Route 1", "Route Gate", "Route 2", "Accumula Gate", "Route 3", "Route 3", "Route 3",
      "Wellspring Cave", "Wellspring Cave", "Route 4", "Route 4", "Route 4", "Route 5",
      "Route 5", "Route 6", "Route 6", "Mistralton Cave", "Mistralton Cave", "Guidance Chamber", "Route 6", "Route 7",
      "Celestial Tower", "Celestial Tower", "Celestial Tower",
      "Celestial Tower", "Celestial Tower", "Route 7", "Route 7", "Route 8", "Moor of Icirrus", "Bridge Gate", "Route 9",
      "Bridge Gate", "Shopping Mall", "Shopping Mall", "Challenger's Cave",
      "Challenger's Cave", "Challenger's Cave", "Route 10", "Route 10", "Route 10", "Route 10", "Route 10", "Route 10",
      "Route 10", "Route 10", "Route 10", "Route 10", "Route 11",
      "Bridge Gate", "Route 11", "Route 12", "Bridge Gate", "Route 13", "Route 13", "Undella Gate", "Route 13",
      "Route 14", "Black Gate", "Abundant Shrine", "Abundant Shrine", "Route 15",
      "Black Gate", "Bridge Gate", "Poké Transfer Lab", "Route 15", "Route 16", "Bridge Gate", "Lostlorn Forest",
      "Lostlorn Forest", "Route 18", "Route 18", "Nuvema Town", "Nuvema Town",
      "Nuvema Town", "Nuvema Town", "Nuvema Town", "Nuvema Town", "Nuvema Town", "Nuvema Town", "Accumula Town",
      "Accumula Town", "Accumula Town", "Accumula Town", "Accumula Town",
      "Accumula Town", "Accumula Town", "Accumula Town", "Accumula Town", "Lacunosa Town", "Lacunosa Town",
      "Lacunosa Town", "Lacunosa Town", "Lacunosa Town", "Lacunosa Town", "Undella Town",
      "Undella Town", "Undella Town", "Undella Town", "Undella Town", "Undella Town", "Anville Town", "Anville Town",
      "Anville Town", "Anville Town", "－－－－－－－－－－", "Route 17",
...
function setPredictedDateTime()
      local nextSeconds, nextMinutes, nextHours, nextDays = dateTime["second"], dateTime["minute"], dateTime["hour"],
          dateTime["day"]
...
function getHPTypeAndPower(hpIV, atkIV, defIV, spAtkIV, spDefIV, spdIV)
      local hpType = floor(((hpIV % 2) + 2 * (atkIV % 2) + 4 * (defIV % 2) + 8 * (spdIV % 2) + 16 * (spAtkIV % 2)
            + 32 * (spDefIV % 2)) * 15 / 63)
      local hpPower = 30 +
      floor((((hpIV >> 1) % 2) + 2 * ((atkIV >> 1) % 2) + 4 * ((defIV >> 1) % 2) + 8 * ((spdIV >> 1) % 2)
...
function showInfo(pidAddr)
      ...
      if mode[index] ~= "Breeding" or isEgg then
            gui.text(5, 404,
                  "Species: " ..
                  speciesNamesList[(speciesDexIndex > 649 or speciesDexIndex < 1) and 1 or speciesDexIndex])
            gui.text(5, 422, "PID:")
            gui.text(53, 422, string.format("%08X%s", pokemonPID, shinyType), shinyTypeTextColor)
            gui.text(5, 440, "Nature: " .. natureNamesList
            [(natureIndex > 25 or natureIndex == nil) and 1 or natureIndex])
            gui.text(5, 458,
                  string.format("Ability: %s (%s)",
                        abilityNamesList[(abilityIndex > 164 or abilityIndex < 1) and 1 or abilityIndex],
                        hiddenAbilityFlag and "H" or
                        abilityIndex ==
                        pokemonAbilities[(speciesDexIndex > 649 or speciesDexIndex < 1) and 1 or speciesDexIndex][1] and
                        "0" or "1"))
...
function getRoamerInfo(roamerAddr)
      ...
      if isRoamerActive then
            ...
            return isRoamerActive, roamerMapIndex,
                (roamerNatureIndex > 25 or roamerNatureIndex == nil) and 1 or roamerNatureIndex, roamerIVsValue,
                roamerPID, roamerShinyTypeTextColor, roamerShinyType,
                (roamerSpeciesIndex > 649 or roamerSpeciesIndex < 1) and 1 or roamerSpeciesIndex,
...
function showRoamerInfo(roamerAddr)
      ...
      roamerShinyType, roamerSpeciesIndex, roamerHP, roamerLevel, roamerStatus, playerMapIndex = getRoamerInfo(
      roamerAddr)
      ...
      if isRoamerActive then
            ...
            gui.text(5, 584, (roamerMapIndex > 427 or roamerMapIndex < 1) and "" or locationNamesList
                  [roamerMapIndex + 1],
...
function showPokemonInfo()
      ...
      elseif infoMode[infoIndex] == "Box" then
            ...
            local boxSelectedPokemonAddr = boxAddr + (0x88 * boxSelectedSlotIndex) + (0x10 * currBoxIndex) +
            (0x88 * currBoxIndex * 0x1E)
