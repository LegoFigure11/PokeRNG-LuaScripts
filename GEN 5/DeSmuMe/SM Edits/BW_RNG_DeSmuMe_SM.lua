...
local itemNamesList = {
  ...
  "Rare Candy",
  "PP Up", "Zinc", "PP Max", "Old Gateau", "Guard Spec.", "Dire Hit", "X Attack", "X Defend", "X Speed", "X Accuracy",
  "X Special",
  ...
  "Repel",
  "Sun Stone", "Moon Stone", "Fire Stone", "Thunder Stone", "Water Stone", "Leaf Stone", "TinyMushroom", "Big Mushroom",
  "Pearl",
  ...
  "Wiki Berry",
  "Mago Berry", "Aguav Berry", "Iapapa Berry", "Razz Berry", "Bluk Berry", "Nanab Berry", "Wepear Berry", "Pinap Berry",
  "Pomeg Berry",
  ...
  "Mental Herb",
  "Choice Band", "King's Rock", "SilverPowder", "Amulet Coin", "Cleanse Tag", "Soul Dew", "DeepSeaTooth", "DeepSeaScale",
  "Smoke Ball",
  ...
  "Power Band",
  "Power Anklet", "Power Weight", "Shed Shell", "Big Root", "Choice Specs", "Flame Plate", "Splash Plate", "Zap Plate",
  "Meadow Plate",
  "Icicle Plate", "Fist Plate", "Toxic Plate", "Earth Plate", "Sky Plate", "Mind Plate", "Insect Plate", "Stone Plate",
  "Spooky Plate",
  "Draco Plate", "Dread Plate", "Iron Plate", "Odd Incense", "Rock Incense", "Full Incense", "Wave Incense",
  "Rose Incense",
  "Luck Incense", "Pure Incense", "Protector", "Electirizer", "Magmarizer", "Dubious Disc", "Reaper Cloth", "Razor Claw",
  "Razor Fang",
  "TM01", "TM02", "TM03", "TM04", "TM05", "TM06", "TM07", "TM08", "TM09", "TM10", "TM11", "TM12", "TM13", "TM14", "TM15",
  "TM16", "TM17",
  "TM18", "TM19", "TM20", "TM21", "TM22", "TM23", "TM24", "TM25", "TM26", "TM27", "TM28", "TM29", "TM30", "TM31", "TM32",
  "TM33", "TM34",
  "TM35", "TM36", "TM37", "TM38", "TM39", "TM40", "TM41", "TM42", "TM43", "TM44", "TM45", "TM46", "TM47", "TM48", "TM49",
  "TM50", "TM51",
  "TM52", "TM53", "TM54", "TM55", "TM56", "TM57", "TM58", "TM59", "TM60", "TM61", "TM62", "TM63", "TM64", "TM65", "TM66",
  "TM67", "TM68",
  "TM69", "TM70", "TM71", "TM72", "TM73", "TM74", "TM75", "TM76", "TM77", "TM78", "TM79", "TM80", "TM81", "TM82", "TM83",
  "TM84", "TM85",
  ...
  "Seal Bag", "Pal Pad",
  "Works Key", "Old Charm", "Galactic Key", "Red Chain", "Town Map", "Vs. Seeker", "Coin Case", "Old Rod", "Good Rod",
  "Super Rod",
  ...
  "Secret Key", "Apricorn Box", "Unown Report", "Berry Pots", "Dowsing MCHN", "Blue Card", "SlowpokeTail", "Clear Bell",
  "Card Key",
  ...
  "Poison Gem",
  "Ground Gem", "Flying Gem", "Psychic Gem", "Bug Gem", "Rock Gem", "Ghost Gem", "Dragon Gem", "Dark Gem", "Steel Gem",
  "Normal Gem",
  "Health Wing", "Muscle Wing", "Resist Wing", "Genius Wing", "Clever Wing", "Swift Wing", "Pretty Wing", "Cover Fossil",
  "Plume Fossil",
  "Liberty Pass", "Pass Orb", "Dream Ball", "Poké Toy", "Prop Case", "Dragon Skull", "BalmMushroom", "Big Nugget",
  "Pearl String",
  "Comet Shard", "Relic Copper", "Relic Silver", "Relic Gold", "Relic Vase", "Relic Band", "Relic Statue", "Relic Crown",
  "Casteliacone",
...
local locationNamesList = { "Black City", "Black City", "Black City", "Black City", "Black City", "Black City",
  ...
  "Striaton City", "Striaton City", "Striaton City", "Striaton City", "Striaton City", "Striaton City", "Striaton City",
  "Nacrene City", "Nacrene City", "Nacrene City",
  ...
  "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City",
  "Castelia City", "Castelia City", "Castelia City",
  "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City", "Castelia City",
  "Castelia City", "Castelia City", "Castelia City",
  "Castelia City", "Castelia City", "Castelia Gate", "Royal Unova", "Castelia City", "Castelia City", "Castelia City",
  "Castelia City", "Castelia City", "Castelia City",
  ...
  "Opelucid City", "Opelucid City", "Opelucid City", "Opelucid City", "Opelucid Gate", "Opelucid Gate", "Opelucid Gate",
  "Opelucid City", "Opelucid City", "Pokémon League",
  ...
  "P2 Laboratory", "P2 Laboratory", "Undella Bay", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins",
  "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins", "Abyssal Ruins",
  ...
  "Village Bridge", "Village Bridge", "Village Bridge", "Village Bridge", "Marvelous Bridge", "N's Castle", "N's Castle",
  "N's Castle", "N's Castle", "N's Castle", "N's Castle",
  ...
  "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest", "Entree Forest",
  "Nimbasa City", "Driftveil City", "Mistralton City",
  "Icirrus City", "Opelucid City", "Black City", "White Forest", "Cold Storage", "Chargestone Cave", "Twist Mountain",
  "Dragonspiral Tower", "Giant Chasm", "Driftveil Drawbridge",
  "Tubeline Bridge", "Marvelous Bridge", "Route 5", "Route 6", "Route 7", "Route 8", "Route 9", "Route 11", "Route 12",
  "Route 13", "Route 14", "Route 15", "Route 16", "Lacunosa Town",
  ...
  "Bridge Gate", "Route 11", "Route 12", "Bridge Gate", "Route 13", "Route 13", "Undella Gate", "Route 13", "Route 14",
  "Black Gate", "Abundant Shrine", "Abundant Shrine", "Route 15",
  ...
  "Accumula Town", "Accumula Town", "Accumula Town", "Accumula Town", "Lacunosa Town", "Lacunosa Town", "Lacunosa Town",
  "Lacunosa Town", "Lacunosa Town", "Lacunosa Town", "Undella Town",
...
function getHPTypeAndPower(hpIV, atkIV, defIV, spAtkIV, spDefIV, spdIV)
  local hpType = floor(((hpIV % 2) + 2 * (atkIV % 2) + 4 * (defIV % 2) + 8 * (spdIV % 2) + 16 * (spAtkIV % 2)
    + 32 * (spDefIV % 2)) * 15 / 63)
  local hpPower = 30 +
  floor(((rshift(hpIV, 1) % 2) + 2 * (rshift(atkIV, 1) % 2) + 4 * (rshift(defIV, 1) % 2) + 8 * (rshift(spdIV, 1) % 2)
...
function showInfo(pidAddr)
  ...
  if mode[index] ~= "Breeding" or isEgg then
    gui.text(2, 14,
      "Species: " .. speciesNamesList[(speciesDexIndex > 649 or speciesDexIndex < 1) and 1 or speciesDexIndex])
    gui.text(2, 25, "PID:")
    ...
    gui.text(2, 47,
      string.format("Ability: %s (%s)", abilityNamesList[(abilityIndex > 164 or abilityIndex < 1) and 1 or abilityIndex],
        hiddenAbilityFlag and "H" or
        abilityIndex == pokemonAbilities[(speciesDexIndex > 649 or speciesDexIndex < 1) and 1 or speciesDexIndex][1] and
        "0" or "1"))
  ...
  if statesFile then               -- Check if the state file has been created correctly
    for slotNumber = 1, 10 do
      if slotNumber == stateSlot then -- Write only in the line of the saved slot
        statesFile:write(string.format("%08X %08X %08X %d %d %08X %d %s\n", initialSeedHigh, initialSeedLow,
          tempCurrentSeedLow, advances,
...
function writeStateFile(statesFileName, stateSlot)
  ...
  for line in statesFile:lines() do
    if line_num == stateSlot then -- Overwrite only the line of the saved slot
      line = string.format("%08X %08X %08X %d %d %08X %d %s", initialSeedHigh, initialSeedLow, tempCurrentSeedLow,
        advances,
        mtCounter, cgearSeed, hitDelay, (hitDate:gsub("\n", " ")))
    end
