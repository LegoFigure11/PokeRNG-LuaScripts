...
M.mode = { " Party ", " Enemy ", "Enemy 2", "Partner", "  Wild " }
...
M.pokemon = {
	...
	"Meloetta", "Genesect", "Pok�mon Egg", "Manaphy Egg"
}
...
M.item_gen4 = {
	"none", "Master Ball", "Ultra Ball", "Great Ball", "Pok� Ball",
	...
	"X Special", "X Sp. Def", "Pok� Doll", "Fluffy Tail", "Blue Flute",
	...
	"Odd Keystone", "unknown1", "unknown2", "unknown3", "unknown4", "unknown5",
	...
	"unknown22", "Griseous Orb", "Adamant Orb", "Lustrous Orb", "Grass Mail",
	"Flame Mail", "Bubble Mail", "Bloom Mail", "Tunnel Mail", "Steel Mail",
	"Heart Mail", "Snow Mail", "Space Mail", "Air Mail", "Mosaic Mail",
	"Brick Mail", "Cheri Berry", "Chesto Berry", "Pecha Berry", "Rawst Berry",
	...
	"HM03", "HM04", "HM05", "HM06", "HM07", "HM08", "Explorer Kit", "Loot Sack",
	"Rule Book", "Pok� Radar", "Point Card", "Journal", "Seal Case",
	"Fashion Case", "Seal Bag", "Pal Pad", "Works Key", "Old Charm",
	"Galactic Key", "Red Chain", "Town Map", "Vs. Seeker", "Coin Case",
	"Old Rod", "Good Rod", "Super Rod", "Sprayduck", "Poffin Case", "Bicycle",
	"Suite Key", "Oak's Letter", "Lunar Wing", "Member Card", "Azure Flute",
	"S.S. Ticket", "Contest Pass", "Magma Stone", "Parcel", "Coupon 1",
	"Coupon 2", "Coupon 3", "Storage Key", "SecretPotion", "Vs. Recorder",
	"Gracidea Flower", "Secret Key", "Apricorn Case", "Unown Notebook",
	"Berry Planter", "Dowsing Machine", "Blue Card", "Slowpoke Tail",
	"Clear Bell", "Card Key", "Basement Key", "Squirtbottle", "Red Scale",
	"Lost Property", "Linear Pass", "Weird Part", "Silver Wing", "Rainbow Wing",
	"Mystery Egg", "Red Apricorn", "Yellow Apricorn", "Blue Apricorn",
	"Green Apricorn", "Pink Apricorn", "White Apricorn", "Black Apricorn",
	"Fast Ball", "Level Ball", "Lure Ball", "Heavy Ball", "Love Ball",
	"Friend Ball", "Moon Ball", "Competition Ball", "Park Ball", "Photo Album",
	"GB Player", "Sea Bell", "Manju Anchor", "Date Card 01", "Date Card 02",
	"Date Card 03", "Date Card 04", "Date Card 05", "Date Card 06",
	"Date Card 07", "Date Card 08", "Date Card 09", "Date Card 10",
	"Date Card 11", "Date Card 12", "Date Card 13", "Date Card 14",
	"Date Card 15", "Date Card 16", "Date Card 17", "Date Card 18",
	"Date Card 19", "Date Card 20", "Date Card 21", "Date Card 22",
	"Date Card 23", "Date Card 24", "Date Card 25", "Date Card 26",
	"Date Card 27", "Green Orb", "Rock Capsule", "Red Orb", "Blue Orb",
	"Crystal Puzzle"
}
...
M.item_gen5 = {
	...
	"Loot Sack", "Rule Book", "Pok� Radar", "Point Card", "Journal",
	...
	"Plume Fossil", "Liberty Pass", "Pass Orb", "Dream Ball", "Pok� Toy",
