...
function showInfo(pidAddr)
      ...
      if mode[index] ~= "Breeding" or isEgg then
            ...
            gui.text(2, -167, "Nature: " ..
                  natureNamesList[(natureIndex > 25 or natureIndex == nil) and 1 or natureIndex])
            gui.text(2, -156,
...
function showRoamerInfo(roamerAddr)
      ...
      roamerSpeciesIndex, roamerHP, roamerLevel, roamerStatus, roamerNatureIndex, playerMapIndex = getRoamerInfo(
            roamerAddr)
