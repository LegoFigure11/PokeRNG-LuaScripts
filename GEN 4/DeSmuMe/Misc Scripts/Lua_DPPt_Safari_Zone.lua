...
local game
local pointer
local zones = { "Plains", "Meadow", "Savannah", "Peak", "Rocky Beach", "Wetland", "Forest", "Swamp", "Marshland",
	"Wasteland", "Mountain", "Desert" }
local offset

local marshdp = { "Croagunk", "Skorupi", "Carnivine", "Croagunk", "Skorupi", "Carnivine", "Golduck", "Croagunk",
	"Skorupi", "Carnivine", "Roselia", "Staravia", "Toxicroak", "Drapion", "Exeggcute", "Golduck", "Staravia",
	"Croagunk", "Skorupi", "Carnivine", "Yanma", "Shroomish", "Paras", "Kangaskhan", "Gulpin", "Roselia", "Staravia",
	"Croagunk", "Skorupi", "Carnivine", "Roselia", "Golduck" }
local marshpt = { "Toxicroak", "Kecleon", "Kecleon", "Carnivine", "Skorupi", "Croagunk", "Quagsire", "Drapion",
	"Skorupi", "Croagunk", "Quagsire", "Kangaskhan", "Paras", "Drapion", "Exeggcute", "Exeggcute", "Skorupi",
	"Croagunk", "Skorupi", "Carnivine", "Yanma", "Shroomish", "Paras", "Kangaskhan", "Gulpin", "Tropius", "Gulpin",
	"Shroomish", "Skorupi", "Carnivine", "Croagunk", "Tangela" }
local trophydp = { "Eevee", "Bonsly", "Happiny", "Meowth", "Cleffa", "Clefairy", "Igglybuff", "Plusle", "Jigglypuff",
	"Porygon", "Castform", "Minun", "Mime Jr", "Marill", "Chansey", "Azurill" }
local trophypt = { "Eevee", "Bonsly", "Happiny", "Meowth", "Cleffa", "Clefairy", "Igglybuff", "Plusle", "Jigglypuff",
	"Ditto", "Castform", "Minun", "Mime Jr", "Marill", "Chansey", "Azurill" }
