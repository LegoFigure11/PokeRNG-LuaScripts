...
local JUMP_DATA = {
      ...
      { 0xCFDDDF21, 0x67DBB608 }, { 0x5F748241, 0xCBA72510 },
      { 0x8B2E1481, 0x1D29AE20 }, { 0x76006901, 0xBA84EC40 },
      { 0x1711D201, 0x79F01880 }, { 0xBE67A401, 0x8793100 }, { 0xDDDF4801, 0x6B566200 },
      { 0x3FFE9001, 0x803CC400 }, { 0x90FD2001, 0xA6B98800 },
      { 0x65FA4001, 0xE6731000 }, { 0xDBF48001, 0x30E62000 },
      { 0xF7E90001, 0xF1CC4000 }, { 0xEFD20001, 0x23988000 },
      { 0xDFA40001, 0x47310000 }, { 0xBF480001, 0x8E620000 },
      { 0x7E900001, 0x1CC40000 }, { 0xFD200001, 0x39880000 },
      { 0xFA400001, 0x73100000 }, { 0xF4800001, 0xE6200000 },
      { 0xE9000001, 0xCC400000 }, { 0xD2000001, 0x98800000 },
      { 0xA4000001, 0x31000000 }, { 0x48000001, 0x62000000 },
      { 0x90000001, 0xC4000000 }, { 0x20000001, 0x88000000 },
      { 0x40000001, 0x10000000 }, { 0x80000001, 0x20000000 }, { 0x1, 0x40000000 },
      { 0x1, 0x80000000 }
}
...
local speciesNamesList = {
      ...
      "Dragonair", "Dragonite", "Mewtwo", "Mew", -- Gen 2
      ...
      "Pupitar", "Tyranitar", "Lugia", "Ho-Oh", "Celebi", -- Gen 3
      ...
      "Kyogre", "Groudon", "Rayquaza", "Jirachi", "Deoxys", -- Gen 4
...
local abilityNamesList = {
      ...
      "Synchronize", "Clear Body", "Natural Cure", "Lightning Rod",
      ...
      "Shell Armor", "Air Lock", -- Gen 4
      "Tangled Feet", "Motor Drive", "Rivalry", "Steadfast", "Snow Cloak",
      "Gluttony", "Anger Point", "Unburden", "Heatproof", "Simple", "Dry Skin",
      "Download", "Iron Fist", "Poison Heal", "Adaptability", "Skill Link",
      "Hydration", "Solar Power", "Quick Feet", "Normalize", "Sniper",
      "Magic Guard", "No Guard", "Stall", "Technician", "Leaf Guard", "Klutz",
      "Mold Breaker", "Super Luck", "Aftermath", "Anticipation", "Forewarn",
      "Unaware", "Tinted Lens", "Filter", "Slow Start", "Scrappy", "Storm Drain",
...
local moveNamesList = {
      ...
      "Vice Grip", "Guillotine", "Razor Wind", "Swords Dance", "Cut", "Gust",
      ...
      "Sing", "Supersonic", "Sonic Boom", "Disable", "Acid", "Ember",
      "Flamethrower", "Mist", "Water Gun", "Hydro Pump", "Surf", "Ice Beam",
      "Blizzard", "Psybeam", "Bubble Beam", "Aurora Beam", "Hyper Beam", "Peck",
      "Drill Peck", "Submission", "Low Kick", "Counter", "Seismic Toss",
      "Strength", "Absorb", "Mega Drain", "Leech Seed", "Growth", "Razor Leaf",
      ...
      "Tri Attack", "Super Fang", "Slash", "Substitute", "Struggle", -- Gen 2
      ...
      "Tail Glow", "Luster Purge", "Mist Ball", "Feather Dance", "Teeter Dance",
      ...
      "Metal Sound", "Grass Whistle", "Tickle", "Cosmic Power", "Water Spout",
      ...
      "Shock Wave", "Water Pulse", "Doom Desire", "Psycho Boost", -- Gen 4
...
local itemNamesList = {
      ...
      "X Special", "X Sp. Def", "Poké Doll", "Fluffy Tail", "Blue Flute",
      ...
      "Odd Keystone", "Griseous Orb", "unknown1", "unknown2", "unknown3",
      ...
      "unknown20", "unknown21", "unknown22", "Adamant Orb", "Lustrous Orb",
      ...
      "Berry Pots", "Dowsing MCHN", "Blue Card", "Slowpoke Tail", "Clear Bell",
      "Card Key", "Basement Key", "SquirtBottle", "Red Scale", "Lost Item",
      "Pass", "Machine Part", "Silver Wing", "Rainbow Wing", "Mystery Egg",
      "Red Apricorn", "Yellow Apricorn", "Blue Apricorn", "Green Apricorn",
      ...
      "Tidal Bell", "RageCandyBar", "Data Card 01", "Data Card 02",
...
local locationNamesList = {
      "Mystery Zone", "Mystery Zone", "Mystery Zone", "Jubilife City",
      "Jubilife City", "Jubilife City", "Jubilife City", "Jubilife City",
      "Pokétch Co.", "Pokétch Co.", "Pokétch Co.", "Jubilife TV",
      "Jubilife TV", "Jubilife TV", "Jubilife TV", "Jubilife TV", "Jubilife TV",
      "Jubilife TV", "Jubilife TV", "Jubilife City", "Jubilife City",
      "Jubilife City", "Jubilife City", "Jubilife City", "Jubilife City",
      "Jubilife City", "Jubilife City", "Jubilife City", "Global Terminal",
      "Trainers’ School", "Jubilife City", "Jubilife City", "Jubilife City",
      "Canalave City", "Canalave City", "Canalave City", "Canalave City",
      "Canalave City", "Canalave Library", "Canalave Library", "Canalave Library",
      "Canalave City", "Canalave City", "Canalave City", "Canalave City",
      "Oreburgh City", "Oreburgh City", "Oreburgh City", "Oreburgh City",
      "Oreburgh City", "Oreburgh City", "Oreburgh City", "Oreburgh City",
      "Oreburgh City", "Oreburgh City", "Oreburgh City", "Oreburgh City",
      "Oreburgh City", "Oreburgh City", "Mining Museum", "Oreburgh City",
      "Oreburgh City", "Oreburgh City", "Oreburgh City", "Oreburgh City",
      "Eterna City", "Eterna City", "Eterna City", "Eterna City", "Eterna City",
      "Eterna City", "Cycle Shop", "T.G. Eterna Bldg", "T.G. Eterna Bldg",
      "T.G. Eterna Bldg", "T.G. Eterna Bldg", "Eterna City", "Eterna City",
      "Eterna City", "Eterna City", "Route 206", "Eterna City", "Eterna City",
      "Eterna City", "Eterna City", "Eterna City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Hearthome City", "Hearthome City", "Route 208", "Route 209", "Route 212",
      "Hearthome City", "Hearthome City", "Hearthome City", "Hearthome City",
      "Poffin House", "Contest Hall", "Contest Hall", "Foreign Building",
      "Pastoria City", "Pastoria City", "Pastoria City", "Pastoria City",
      "Pastoria City", "Pastoria City", "Pastoria City", "Pastoria City",
      "Pastoria City", "Pastoria City", "Pastoria City", "Pastoria City",
      "Veilstone City", "Veilstone City", "Veilstone City", "Veilstone City",
      "Game Corner", "Veilstone Store", "Veilstone Store", "Veilstone Store",
      "Veilstone Store", "Veilstone Store", "Veilstone Store", "Veilstone City",
      "Veilstone City", "Veilstone City", "Veilstone City", "Veilstone City",
      "Veilstone City", "Route 215", "Sunyshore City", "Sunyshore City",
      "Sunyshore City", "Sunyshore City", "Sunyshore City", "Sunyshore City",
      "Sunyshore City", "Sunyshore Market", "Sunyshore City", "Sunyshore City",
      "Sunyshore City", "Sunyshore City", "Sunyshore City", "Sunyshore City",
      "Vista Lighthouse", "Snowpoint City", "Snowpoint City", "Snowpoint City",
      "Snowpoint City", "Snowpoint City", "Snowpoint City", "Snowpoint City",
      "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League",
      "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League",
      "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League",
      "Pokémon League", "Pokémon League", "Pokémon League", "Pokémon League",
      "Fight Area", "Fight Area", "Fight Area", "Fight Area", "Battle Park",
      "Route 225", "Fight Area", "Fight Area", "Mystery Zone", "Oreburgh Mine",
      "Oreburgh Mine", "Oreburgh Mine", "Valley Windworks", "Valley Windworks",
      "Eterna Forest", "Eterna Forest", "Fuego Ironworks", "Fuego Ironworks",
      "Mystery Zone", "Mt. Coronet", "Mt. Coronet", "Mt. Coronet", "Mt. Coronet",
      "Mt. Coronet", "Mt. Coronet", "Mt. Coronet", "Mt. Coronet", "Mt. Coronet",
      "Mt. Coronet", "Mt. Coronet", "Mt. Coronet", "Mt. Coronet", "Spear Pillar",
      "Spear Pillar", "Mystery Zone", "Pastoria City", "Mystery Zone",
      "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins",
      "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins",
      "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins",
      "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins", "Solaceon Ruins",
      "Solaceon Ruins", "Solaceon Ruins", "Mystery Zone", "Victory Road",
      "Victory Road", "Victory Road", "Victory Road", "Victory Road",
      "Victory Road", "Mystery Zone", "Pal Park", "Mystery Zone", "Amity Square",
      "Ravaged Path", "Mystery Zone", "Floaroma Meadow", "Floaroma Meadow",
      "Oreburgh Gate", "Oreburgh Gate", "Fullmoon Island", "Fullmoon Island",
      "Stark Mountain", "Stark Mountain", "Stark Mountain", "Stark Mountain",
      "Mystery Zone", "Sendoff Spring", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Flower Paradise", "Mystery Zone", "Mystery Zone", "Mystery Zone",
      "Snowpoint Temple", "Snowpoint Temple", "Snowpoint Temple",
      "Snowpoint Temple", "Snowpoint Temple", "Snowpoint Temple", "Wayward Cave",
      "Wayward Cave", "Ruin Maniac Cave", "Trophy Garden", "Iron Island",
      "Iron Island", "Iron Island", "Iron Island", "Iron Island", "Iron Island",
      "Iron Island", "Old Chateau", "Old Chateau", "Old Chateau", "Old Chateau",
      "Old Chateau", "Old Chateau", "Old Chateau", "Old Chateau", "Old Chateau",
      "Mystery Zone", "Galactic HQ", "Galactic HQ", "Galactic HQ", "Galactic HQ",
      "Galactic HQ", "Galactic HQ", "Lake Verity", "Lake Verity", "Verity Cavern",
      "Lake Valor", "Lake Valor", "Valor Cavern", "Lake Acuity", "Lake Acuity",
      "Acuity Cavern", "Newmoon Island", "Newmoon Island", "Battle Park",
      "Battle Park", "Mystery Zone", "Mystery Zone", "Battle Tower",
      "Battle Tower", "Battle Tower", "Battle Tower", "Battle Tower",
      "Battle Tower", "Mystery Zone", "Mystery Zone", "Verity Lakefront",
      "Verity Lakefront", "Valor Lakefront", "Restaurant", "Grand Lake",
      "Grand Lake", "Acuity Lakefront", "Spring Path", "Route 201", "Route 202",
      "Route 203", "Route 204", "Route 204", "Route 205", "Route 205",
      "Route 205", "Route 206", "Route 206", "Mystery Zone", "Route 207",
      "Route 208", "Route 208", "Route 209", "Route 209", "Route 209",
      "Route 209", "Route 209", "Route 209", "Route 210", "Route 210",
      "Route 210", "Route 211", "Route 211", "Route 212", "Pokémon Mansion",
      "Pokémon Mansion", "Pokémon Mansion", "Route 212", "Route 212",
      "Route 213", "Route 213", "Footstep House", "Grand Lake", "Grand Lake",
      "Grand Lake", "Grand Lake", "Route 214", "Route 214", "Route 215",
      "Route 216", "Route 216", "Route 217", "Route 217", "Route 217",
      "Route 218", "Route 218", "Route 218", "Route 219", "Route 221", "Pal Park",
      "Route 221", "Route 222", "Route 222", "Route 222", "Route 222",
      "Route 224", "Route 225", "Mystery Zone", "Mystery Zone", "Route 227",
      "Mystery Zone", "Mystery Zone", "Route 228", "Route 229", "Mystery Zone",
      "Mystery Zone", "Mystery Zone", "Twinleaf Town", "Twinleaf Town",
      "Twinleaf Town", "Twinleaf Town", "Twinleaf Town", "Twinleaf Town",
      "Twinleaf Town", "Sandgem Town", "Sandgem Town", "Sandgem Town",
      "Sandgem Town", "Sandgem Town", "Sandgem Town", "Sandgem Town",
      "Sandgem Town", "Floaroma Town", "Floaroma Town", "Floaroma Town",
      "Floaroma Town", "Flower Shop", "Floaroma Town", "Floaroma Town",
      "Solaceon Town", "Solaceon Town", "Solaceon Town", "Solaceon Town",
      "Pokémon Day Care", "Solaceon Town", "Solaceon Town", "Solaceon Town",
      "Solaceon Town", "Celestic Town", "Celestic Town", "Celestic Town",
      "Celestic Town", "Celestic Town", "Celestic Town", "Celestic Town",
      "Celestic Town", "Survival Area", "Survival Area", "Survival Area",
      "Survival Area", "Battleground", "Survival Area", "Survival Area",
      "Resort Area", "Resort Area", "Resort Area", "Resort Area", "Resort Area",
      "Resort Area", "Resort Area", "Villa", "Resort Area", "Mystery Zone",
      "Route 220", "Route 223", "Route 226", "Mystery Zone", "Route 230",
      "Seabreak Path", "Mystery Zone", "Jubilife City", "Canalave City",
      "Oreburgh City", "Eterna City", "Hearthome City", "Pastoria City",
      "Veilstone City", "Sunyshore City", "Snowpoint City", "Pokémon League",
      "Fight Area", "Sandgem Town", "Floaroma Town", "Solaceon Town",
      "Celestic Town", "Survival Area", "Resort Area", "Canalave City", "Café",
      "Battle Tower", "Galactic HQ", "Pokémon League", "Pokémon League",
      "Galactic HQ", "Route 225", "Route 226", "Route 227", "Route 228",
      "Route 228", "Route 228", "Great Marsh", "Great Marsh", "Great Marsh",
      "Great Marsh", "Great Marsh", "Great Marsh", "Hall of Origin",
      "Hall of Origin", "Ruin Maniac Cave", "Maniac Tunnel", "Iron Island",
      "Solaceon Ruins", "Vista Lighthouse", "Jubilife City", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      ...
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Turnback Cave",
      "Turnback Cave", "Turnback Cave", "Turnback Cave", "Contest Hall",
      "Battle Frontier", "Battle Frontier", "Battle Tower", "Battle Factory",
      "Battle Hall", "Battle Castle", "Battle Arcade", "Veilstone Store",
      "Global Terminal", "Global Terminal", "Galactic HQ", "Distortion World",
      "ROTOM’s Room", "T.G. Eterna Bldg", "Distortion World",
      "Distortion World", "Distortion World", "Distortion World",
      "Distortion World", "Distortion World", "Distortion World",
      "Distortion World", "Distortion World", "Distortion World",
      "Distortion World", "Spear Pillar", "Spear Pillar", "Jubilife City",
      "Iron Island", "Iron Ruins", "Mt. Coronet", "Iceberg Ruins", "Route 228",
      "Rock Peak Ruins"
}
...
local mtIndexAddr, pidPointerAddr, delayAddr, currentSeedAddr, mtSeedAddr,
trainerIDsPointerAddr, tempCurrentSeedDuringBattleAddr
...
function printGameInfo()
      ...
      elseif gameVersion ~= "Platinum" then
            print(string.format(
                  "Version: %s - Wrong game version! Use Platinum instead\n",
                  gameVersion))
...
local mode, index = {
      "None", "Capture", "Breeding", "Roamer", "Pandora", "Pokemon Info"
}, 1

function setBackgroundBoxes() -- Set transparent black boxes
      if mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] ==
          "Pokemon Info" then
...
function setDateTime()
      ...
      dateTime["hour"] =
          string.format("%02X", read8Bit(dateTimeAddr + 0x4) % 0x40)
...
function getTabInput()
      ...
      if (key["1"] or key["numpad1"]) and
          (not prevKey["1"] and not prevKey["numpad1"]) then
            leftArrowColor = "orange"
            index = index - 1 < 1 and 6 or index - 1
      elseif (key["2"] or key["numpad2"]) and
          (not prevKey["2"] and not prevKey["numpad2"]) then
...
function buildSeedFromDelay(delay)
      local ab = ((dateTime["month"] * dateTime["day"]) + dateTime["minute"] +
            dateTime["second"]) % 0x100
...
local prevMTSeed, initialSeed, tempCurrentSeed, mtCounter, hitDelay, hitDate,
battleStartJumpFlag = 0, 0, 0, 0, 0, "2000/01/01\n00:00:00", false
...
function setInitialSeed(mtSeed, delay)
      if prevMTSeed ~= mtSeed and delay ~= 0 then
            ...
            local initilSeedGenerationFlag =
                mtSeed == mtSeedTest and 0 or mtSeed == mtSeedTest2 and 1 or mtSeed ==
                mtSeedTest3 and 2 or nil
...
function LCRNGDistance(state0, state1)
      ...
      if state0 ~= state1 then
            for _, data in ipairs(JUMP_DATA) do
                  ...
                  if state0 == state1 then break end
...
function getRngInfo()
      ...
      elseif prevMTSeed ~= mtSeed then                  -- Check when the value of the MT seed changes in RAM
            ...
            prevMTSeed = mtSeed
      elseif tempCurrentSeed == read32Bit(tempCurrentSeedDuringBattleAddr) and
          tempCurrentSeed ~= 0 then -- Check when current seed is set on battle temp current seed address
      ...
      if not battleStartJumpFlag then -- Calculate prng jumps only when not in battle
            advances = mtSeed == current and 0 or advances +
                LCRNGDistance(tempCurrentSeed, current)
      end
...
function getInitialSeedInfoInput()
      ...
      gui.text(2, 182, showInitialSeedInfoText and "7 - Hide Seed info" or
            "8 - Show Seed info")
end
...
function showInitialSeedInfo(delay)
      ...
      gui.text(2, 68, string.format("Next Initial Seed: %08X",
            buildSeedFromDelay(delay + delayOffset, true)))
...
function showDateTime()
      if mode[index] ~= "None" then
            ...
            gui.text(194, 2,
                  string.format("20%s/%s/%s", dateTime["year"],
                        dateTime["month"], dateTime["day"]))
            gui.text(194, 13,
                  string.format("%s:%s:%s", dateTime["hour"], dateTime["minute"],
                        dateTime["second"]))
      end
end
...
function getRngInfoInput()
      ...
      gui.text(152, 182,
            showRngInfoText and "5 - Hide RNG info" or "6 - Show RNG info")
end
...
function getSlotInput()
      ...
      if (key["3"] or key["numpad3"]) and
          (not prevKeySlot["3"] and not prevKeySlot["numpad3"]) then
            leftSlotArrowColor = "orange"
            slotIndex = slotIndex - 1 < 0 and 1 or slotIndex - 1
      elseif (key["4"] or key["numpad4"]) and
          (not prevKeySlot["4"] and not prevKeySlot["numpad4"]) then
...
function getOffset(offsetType, orderIndex)
      local offsets = {
            ["growth"] = {
                  0, 0, 0, 0, 0, 0, 1, 1, 2, 3, 2, 3, 1, 1, 2, 3, 2, 3, 1, 1, 2, 3, 2,
                  3
            },
            ["attack"] = {
                  1, 1, 2, 3, 2, 3, 0, 0, 0, 0, 0, 0, 2, 3, 1, 1, 3, 2, 2, 3, 1, 1, 3,
                  2
            }
      }
...
function shinyCheck(PID, trainerTID, trainerSID)
      ...
      if not trainerTID then trainerTID, trainerSID = getTrainerIDs() end

      local lowPID = band(PID, 0xFFFF)
      local highPID = rshift(PID, 16)
      local shinyTypeValue = bxor(bxor(trainerTID, trainerSID),
            bxor(lowPID, highPID))
...
function getBits(a, b, d) return rshift(a, b) % lshift(1, d) end
...
function getHPTypeAndPower(hpIV, atkIV, defIV, spAtkIV, spDefIV, spdIV)
      local hpType = floor(((hpIV % 2) + 2 * (atkIV % 2) + 4 * (defIV % 2) + 8 *
            (spdIV % 2) + 16 * (spAtkIV % 2) + 32 *
            (spDefIV % 2)) * 15 / 63)
      local hpPower = 30 +
          floor(
                ((rshift(hpIV, 1) % 2) + 2 * (rshift(atkIV, 1) % 2) +
                      4 * (rshift(defIV, 1) % 2) + 8 *
                      (rshift(spdIV, 1) % 2) + 16 *
                      (rshift(spAtkIV, 1) % 2) + 32 *
                      (rshift(spDefIV, 1) % 2)) * 40 / 63)
...
function showIVsAndHP(ivsValue)
      ...
      local hpType, hpPower = getHPTypeAndPower(hpIV, atkIV, defIV, spAtkIV,
            spDefIV, spdIV)
...
function showMoves(moveIndexesList)
      gui.text(2, -101, "Move: " ..
            moveNamesList[moveIndexesList[1] > 468 and 1 or
            moveIndexesList[1]])
      gui.text(2, -90, "Move: " ..
            moveNamesList[moveIndexesList[2] > 468 and 1 or
            moveIndexesList[2]])
      gui.text(2, -79, "Move: " ..
            moveNamesList[moveIndexesList[3] > 468 and 1 or
            moveIndexesList[3]])
      gui.text(2, -68, "Move: " ..
            moveNamesList[moveIndexesList[4] > 468 and 1 or
            moveIndexesList[4]])
end
...
function showInfo(pidAddr)
      ...
      local speciesDexIndex = bxor(read16Bit(pidAddr + growthOffset + 0x8),
            rshift(prng, 16))

      prng = LCRNG(prng, 0x41C64E6D, 0x6073)
      local heldItemIndex = bxor(read16Bit(pidAddr + growthOffset + 0xA),
            rshift(prng, 16)) + 1
      ...
      local abilityIndex = bxor(read16Bit(pidAddr + growthOffset + 0x14),
            rshift(prng, 16))
      ...
      prng = LCRNG(prng, 0x41C64E6D, 0x6073)
      local movePPAux = bxor(read16Bit(pidAddr + attacksOffset + 0x10),
            rshift(prng, 16))
      movePP[1] = getBits(movePPAux, 0, 8)
      movePP[2] = getBits(movePPAux, 8, 8)
      prng = LCRNG(prng, 0x41C64E6D, 0x6073)
      movePPAux =
          bxor(read16Bit(pidAddr + attacksOffset + 0x12), rshift(prng, 16))
      movePP[3] = getBits(movePPAux, 0, 8)
      movePP[4] = getBits(movePPAux, 8, 8)

      prng = LCRNG(prng, 0x807DBCB5, 0x52713895) -- 3 cycles
      ivsPart[1] = bxor(read16Bit(pidAddr + attacksOffset + 0x18),
            rshift(prng, 16))
      prng = LCRNG(prng, 0x41C64E6D, 0x6073)
      ivsPart[2] = bxor(read16Bit(pidAddr + attacksOffset + 0x1A),
            rshift(prng, 16))
      ...
      if mode[index] ~= "Breeding" or isEgg then
            gui.text(2, -189, "Species: " ..
                  speciesNamesList[(speciesDexIndex > 493 or speciesDexIndex <
                        1) and 1 or speciesDexIndex])
            gui.text(2, -178, "PID:")
            gui.text(32, -178, string.format("%08X%s", pokemonPID, shinyType),
                  shinyTypeTextColor)
            gui.text(2, -167, "Nature: " ..
                  natureNamesList[(natureIndex > 25 or natureIndex == nil) and
                  1 or natureIndex])
            gui.text(2, -156,
                  string.format("Ability: %s (%s)",
                        abilityNamesList[(abilityIndex > 123 or
                              abilityIndex < 1) and 1 or abilityIndex],
                        abilityIndex ==
                        pokemonAbilities[(speciesDexIndex > 493 or
                              speciesDexIndex < 1) and 1 or
                        speciesDexIndex][1] and "0" or "1"))

            showIVsAndHP(ivsValue)

            gui.text(2, -123, "Held item: " ..
                  itemNamesList[(heldItemIndex > 537) and 1 or heldItemIndex])

            showMoves(move)
            showPP(movePP)

            if mode[index] == "Pokemon Info" then showPokemonIDs(OTID, OTSID) end
      end
end
...
function getRoamerSlotInput()
      ...
      if (key["3"] or key["numpad3"]) and
          (not prevKeyRoamerSlot["3"] and not prevKeyRoamerSlot["numpad3"]) then
            leftRoamerSlotArrowColor = "orange"
            roamerSlotIndex = roamerSlotIndex - 1 < 0 and 4 or roamerSlotIndex - 1
      elseif (key["4"] or key["numpad4"]) and
          (not prevKeyRoamerSlot["4"] and not prevKeyRoamerSlot["numpad4"]) then
...
function getRoamerInfo(roamerAddr)
      ...
      if isRoamerActive then
            ...
            return isRoamerActive, roamerMapIndex, roamerIVsValue, roamerPID,
                roamerShinyTypeTextColor, roamerShinyType,
                (roamerSpeciesIndex > 493 or roamerSpeciesIndex < 1) and 1 or
                roamerSpeciesIndex, roamerHP, roamerLevel, roamerStatus,
                (roamerNatureIndex > 25 or roamerNatureIndex == nil) and 1 or
                roamerNatureIndex, playerMapIndex
      end
...
function showRoamerInfo(roamerAddr)
      local isRoamerActive, roamerMapIndex, roamerIVsValue, roamerPID,
      roamerShinyTypeTextColor, roamerShinyType, roamerSpeciesIndex,
      roamerHP, roamerLevel, roamerStatus, roamerNatureIndex, playerMapIndex =
          getRoamerInfo(roamerAddr)

      if isRoamerActive then
            gui.text(2, -189, "Active Roamer? Yes")
            gui.text(2, -178, "Species: " .. speciesNamesList[roamerSpeciesIndex])
            gui.text(2, -167, "PID:")
            gui.text(32, -167, string.format("%08X%s", roamerPID, roamerShinyType),
                  roamerShinyTypeTextColor)
            ...
            gui.text(2, -79, locationNamesList[roamerMapIndex + 1],
...
local prevKeyInfo, infoIndex, infoMode = {}, 1, {
      "Gift", "Party", "Party Stats", "Box", "Box Stats"
}
...
function getInfoInput()
      ...
      if (key["3"] or key["numpad3"]) and
          (not prevKeyInfo["3"] and not prevKeyInfo["numpad3"]) then
            leftInfoArrowColor = "orange"
            infoIndex = infoIndex - 1 < 1 and 5 or infoIndex - 1
      elseif (key["4"] or key["numpad4"]) and
          (not prevKeyInfo["4"] and not prevKeyInfo["numpad4"]) then
...
function showPokemonInfo(pidAddr)
      ...
      elseif infoMode[infoIndex] == "Party" then
            ...
            local partySelectedPokemonAddr = partyAddr +
                (partySelectedSlotIndex * 0xEC)
      ...
      elseif infoMode[infoIndex] == "Party Stats" then
            ...
            local partyStatsSelectedSlotIndex = read8Bit(
                  partyStatsSelectedSlotIndexAddr)
            local pokemonPartyStatsAddr = partyAddr +
                (partyStatsSelectedSlotIndex * 0xEC)
      ...
      elseif infoMode[infoIndex] == "Box" then
            ...
            local boxSelectedPokemonAddr = boxAddr + (0x88 * boxSelectedSlotIndex) +
                ((0xFF0 * currBoxIndex))
      ...
      elseif infoMode[infoIndex] == "Box Stats" then
            ...
            local boxStatsSelectedSlotIndex =
                read8Bit(boxStatsSelectedSlotIndexAddr)
            local pokemonBoxStatsAddr =
                boxAddr + (0x88 * boxStatsSelectedSlotIndex) +
                ((0xFF0 * currBoxIndex))
...
function writeStateFile(statesFileName, stateSlot)
      ...
      for line in statesFile:lines() do
            if line_num == stateSlot then -- Overwrite only the line of the saved slot
                  line = string.format("%08X %08X %d %d %d %s %08X %s", initialSeed,
                        tempCurrentSeed, advances, mtCounter, hitDelay,
                        (hitDate:gsub("\n", " ")),
                        lastCurrentSeedBeforeBattle,
                        tostring(battleStartJumpFlag))
            end
...
function getSaveStateInput()
      ...
      for slotNumber = 1, table.getn(Fbuttons) do
            if (key[Fbuttons[slotNumber]] and not prevStateKey[Fbuttons[slotNumber]]) then
                  local statesFileName = string.format(
                        "states/%s_%s_states_values.txt",
                        gameVersion,
...
function main()
      if not wrongGameVersion then
            ...
            if mode[index] ~= "None" then
                  ...
                  if mode[index] ~= "Pokemon Info" then showTrainerIDs() end
            end
