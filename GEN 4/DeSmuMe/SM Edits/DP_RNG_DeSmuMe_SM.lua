...
local prevMTSeed, initialSeed, tempCurrentSeed, mtCounter, hitDelay, hitDate, battleStartJumpFlag = 0, 0, 0, 0, 0,
    "2000/01/01\n00:00:00", false
...
function showInfo(pidAddr)
      ...
      if mode[index] ~= "Breeding" or isEgg then
            gui.text(2, 14,
                  "Species: " ..
                  speciesNamesList[(speciesDexIndex > 493 or speciesDexIndex < 1) and 1 or speciesDexIndex])
            gui.text(2, 25, "PID:")
            ...
            gui.text(2, 47,
                  string.format("Ability: %s (%s)",
                        abilityNamesList[(abilityIndex > 123 or abilityIndex < 1) and 1 or abilityIndex],
                        abilityIndex ==
                        pokemonAbilities[(speciesDexIndex > 493 or speciesDexIndex < 1) and 1 or speciesDexIndex][1] and
                        "0" or "1"))
...
function getRoamerInfo(roamerAddr)
      ...
      if isRoamerActive then
            ...
            return isRoamerActive, roamerPID,
                (roamerSpeciesIndex > 493 or roamerSpeciesIndex < 1) and 1 or roamerSpeciesIndex, roamerShinyType,
                roamerShinyTypeTextColor, (roamerNatureIndex > 25 or roamerNatureIndex == nil) and 1 or roamerNatureIndex,
                roamerIVsValue, roamerLevel, roamerHP,
